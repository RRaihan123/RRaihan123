...
Skills: Node JS, Express JS, MongoDB, React JS, Redux, Angular, MERN, MEAN, JavaScript, TypeScript, HTML, CSS, Bootstrap, LESS, Unit Testing, JSON server, Web Socket,  Docker, Jquery, VS Code, Deployment on Heroku, Git and Github 
