...
Skills: Node JS, Express JS, MongoDB, React JS, Redux, Angular, MERN, MEAN, JavaScript, TypeScript, HTML, CSS, Bootstrap, SASS, LESS, Unit Testing, JSON server, Socket.io, Docker, Microservices, RabbitMQ, API Gateway, Jquery, VS Code, Deployment on Heroku, Git and Github 
